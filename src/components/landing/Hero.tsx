function HeroPreview() {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-border bg-surface p-5 shadow-[0_2px_2px_rgba(0,0,0,0.04),0_8px_16px_-4px_rgba(0,0,0,0.04),0_0_0_1px_var(--border)_inset]">
                  ...
                  {[22, 40, 31, 55, 48, 72].map((barHeight, barIndex) => (
                    <div
                      ...
                      className={`flex-1 rounded-t-full ${
                        index % 2 === 0 ? "bg-accent/70" : "bg-teal/70"
                      }`}
      ...
      <div className="relative mx-auto max-w-350 px-4 pb-20 pt-24 sm:px-6 lg:px-8 lg:pb-24 lg:pt-28">
        <div className="grid items-center gap-12 xl:grid-cols-[0.92fr_1.08fr]">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-5 max-w-xl text-[48px] font-semibold leading-12 tracking-[-0.06em] text-text-primary max-[639px]:text-[36px] max-[639px]:leading-10">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                href="/register"
                className="inline-flex h-12 items-center justify-center rounded-pill bg-accent px-5 text-[16px] font-medium leading-6 text-on-primary transition hover:opacity-90"
              >
                Get Started Free
              </a>
              <a
                href="#how-it-works"
                className="inline-flex h-12 items-center justify-center rounded-pill border border-border bg-surface px-5 text-[16px] font-medium leading-6 text-text-primary transition hover:bg-surface-secondary"
              >
                See How It Works
              </a>
            </div>
